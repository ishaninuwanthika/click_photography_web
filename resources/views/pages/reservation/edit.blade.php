...
<div class="container-fluid">
    <h3 class="h3 mb-2 text-gray-800">Update Reservation - {{ $reservation->number }}</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form id="reservation-form" action="{{ route('update.reservation', $reservation->id) }}" method="POST">
                    @method('POST')
                    @csrf
                    <div class="row">
